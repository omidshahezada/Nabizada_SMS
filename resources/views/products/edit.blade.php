            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="number" class="form-control" placeholder="قیمت خرید را وارد کنید" name="purchase_price" value="{{old('purchase_price', $product->purchase_price)}}">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                  <input type="number" class="form-control" placeholder="قیمت فروش را وارد کنید " name="sell_price" value="{{old('sell_price', $product->sell_price)}}">
                  <div class="input-group-append">
                    <span class="input-group-text">اف</span>
                  </div>
                </div>
